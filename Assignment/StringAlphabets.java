...
public class StringAlphabets {
	...
	public static void main(String[] args) {
		// TODO Auto-generated method stub
		 ...
		 System.out.println("====================");
		 System.out.println(36 + " " + 10 + " " + 7 + " " + 40 +" " + 2 + " " + 16 + " "  + 42 + " " + 1 + " " + 6 + " "+ 20 + "\n");
		 
		 
		 System.out.println("k l m n o p r s t");
		 System.out.println("====================");
		 System.out.println(8 + " " + 35 + " " + 22 + " " + 14 +" "+  12 + " " + 23 + " "  + 4 + " " + 11 + " " + 24 + " "+ t + "\n");
		 

		 System.out.println("u v w x y z");
		 System.out.println("====================");
		 System.out.println(5 + " " + 27 + " " + 13 + " " + 18 +" " + 38 + " " + 37 );
		 }
